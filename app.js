        ...
        <div id="friends-wrapper">
          <div id="new-friend">
            <form onSubmit={this.handleAddNewFriend}>
              <div className="hint hint--bottom" data-hint="blockchainID of your friend - try: bumi"><input id="new-friend-input" placeholder="namecoin blockchainID" /></div>
              <button>Add</button>
            </form>
          </div>
          ...
          <div className="about">
            <h3>About:</h3>
            <p>
              chainbook.bit is a <a href="http://namecoin.org">namecoin</a> and <a href="http://remotestorage.io">remotestorage</a> based addressbook. <a href="https://github.com/bumi/chainbook.bit#readme">Read more about the project on Github</a>
            </p>
            <p><small>Wanted: <a href="http://github.com/bumi/chainbook.bit">Help build a beautiful interface</a></small></p>
